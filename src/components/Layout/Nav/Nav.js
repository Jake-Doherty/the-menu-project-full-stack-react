...
export default function Nav() {
  ...
  return (
    <>
      ...
      >
        <MenuItem id="user-profile" title="Profile" onClick={handleClose}>
          <Avatar /> Profile
        </MenuItem>
        ...
        <MenuItem id="add-recipe" title="Add A Recipe" onClick={handleClose}>
          <ListItemIcon>
        ...
        <MenuItem name="logout" id="logout" title="Logout" onClick={handleLogout}>
          <ListItemIcon>
