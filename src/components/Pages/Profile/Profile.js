      ...
      >
        <FormControl>
          <TextField
            ...
            variant="outlined"
            value={usernameInput}
            placeholder={profile && profile.display_name ? profile.display_name : null}
            onChange={(e) => {
        ...
        <FormControl>
          <TextField
            ...
            maxRows={4}
            value={bioInput}
            placeholder={profile && profile.bio ? profile.bio : null}
            onChange={(e) => {
        ...
        <Button variant="contained" component="label">
          Upload File
          <input onChange={(e) => setProfileAvatarInput(e.target.files[0])} type="file" hidden />
        </Button>
        ...
        <Image
          ...
          src={
            ...
            profile && !profileAvatarUrl && !profile.avatar_image_url
        ...
        <Button variant="contained" onClick={(e) => handleProfileUpdate(e)}>
